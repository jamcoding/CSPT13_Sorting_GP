...
def partition(data):
    # takes in a single list and partitions it in to 3 lists left, pivot, and right
    ...
    # return the tuple of (left, pivot, and right)
...
def quicksort(data):
    ...
    # partition the data in to 3 variables (left, pivot, and right)
    left, pivot, right = partition(data)

    # recursive call to quicksort using the left
    # recursive call to quicksort using the right
    # return the concatanation quicksort of lhs + pivot + quicksort of the rhs
